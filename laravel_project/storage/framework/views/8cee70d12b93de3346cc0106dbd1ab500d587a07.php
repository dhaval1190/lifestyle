        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group <?php echo e($errors->has('environment') ? ' has-error ' : ''); ?>">
                    ...
                    <div id="environment_text_input" class="display-none">
                ...
                <div class="block">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_host') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_host" id="mail_host" value="127.0.0.1" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_tabs.mail_host_placeholder')); ?>" />
                        ...
                        <div class="form-group <?php echo e($errors->has('mail_port') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="number" name="mail_port" id="mail_port" value="587" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_tabs.mail_port_placeholder')); ?>" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Laravel/Techcrave/listdirectory/http/laravel_project/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>