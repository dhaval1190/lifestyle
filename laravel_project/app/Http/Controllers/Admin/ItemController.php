...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validate_rule = [
            ...
            'item_postal_code' => 'required|regex:/^[a-zA-Z0-9]+([- ]?[a-zA-Z0-9]+)*$/|max:10',
    ...
    public function update(Request $request, Item $item)
    {
        ...
        if(!empty($feature_image)){
            ...
            //$feature_image_make = Image::make(base64_decode(preg_replace('#^data:image/\w+;base64,#i', '',$feature_image)));
