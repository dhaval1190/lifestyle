...
<div class="row">
    ...
    <form method="POST" action="{{ route('user.profile.update') }}" class="" enctype="multipart/form-data">
        @csrf
        <div class="col-lg-12">
        <div class="row align-set_center">
            <div class="col-lg-6 col-xl-6 col-xxl-6 col-md-6 col-12">
            ...
            <div class="col-lg-6 col-xl-6 col-xxl-6 text-align-end  col-md-6 col-12">                
                <button type="submit" id="frmSubmit" class="btn btn-primary mb-2 mt-md-5 mt-0  mt-5rem font-set-sm">
                {{ __('Update Profile') }}
                </button>
...
<div class="tabs">
    ...
    <label for="tabone" class="half_section label">Youtube Details</label>
    <div class="tab">
        {{--  Youtube form --}}
                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-4">
                            ...
                            <p class="error_color youtube_video_error"></p>
                        </div>
                        
                        <div class="col-12 col-md-12 col-lg-4">
                            <label for="youtube_media_url" class="text-black">Youtube Video URL</label>
                        ...
                        <div class="col-12 col-md-12 col-lg-3">
                            <label for="youtube_media_url" class="text-black">&nbsp;</label>
                            <button type="submit" class="btn btn-sm btn-block btn-primary rounded text-white align_set_center_all mb-set-sm" id="addYoutubeBtn">
                                <i class="fas fa-plus"></i>{{ __('Add') }}
                            </button>
                            <strong><span class="youtube_success_msg" style="color:green;font"></span></strong>
                        </div>
                        <div class="col-12 col-md-12 col-lg-12 col-xl-12 font_icon_color_diff  pt-md-4 pb-md-4" id="youtube_details_added">
                            @foreach($video_media_array as $video_media_key => $video_media_value)
                                <div class="col-12 p-0 ">
                                    <div class="row border_set_row">
                                        <div class="col-md-6 col-9">
    ...
    <label for="tabtwo" class="half_section label">Ebook Details</label>
    <div class="tab">
      {{--  Ebook form --}}
    ...
    <label for="tabthree" class="half_section label">Podcast Details</label>
    <div class="tab">
      {{--  Podcast form --}}
                                ...
                                <div class="col-md-6 col-9">
                                    <span class="set_width">
                                            <div class="row">
                                                ...
                                                <div class="col-md-11">
                                                    {{ $podcast_media_value->media_name }}
                                                </div>
                                            </div>
                                    </span>                                      
                                </div>
                    ...
                    <div class="col-12 pl-0">
                        ...
                        <form method="POST" id="articleCreateForm" name="articleCreateForm">
                            ...
                            <div class="border-left-primary mb-4">
                                <div class="col-12">
                                    <div class="form-row mb-4 pl-1 pt-1 pb-1">
                                        <div class="col-md-12" style="background-color: #0069D980;">
                                          ...
                                          <span class="text-lg text-gray-800">{{ __('backend.article.feature-image') }}</span>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-12">
                                                    ...
                                                    <img id="article_image_preview" src="{{ asset('backend/images/placeholder/full_item_feature_image.webp') }}" class="w-100">
...
@foreach($video_media_array as $video_media_key => $video_media_value)
    <div class="modal fade" id="editMediaModal_{{ $video_media_value->id }}" tabindex="-1" role="dialog" aria-labelledby="editMediaModal_{{ $video_media_value->id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle" style="color: black;">{{ __('Edit Media') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
@section('scripts')
    ...
    //For youtube videos
    $('#youtubeVideoFrm').on('submit', function(e) {
        e.preventDefault();
        $('#addYoutubeBtn').prop("disabled", true);
        $('.youtube_video_error').text(''); 
        $('.youtube_url_error').text(''); 
        var formData = new FormData(this);
        
        var ajax_url = '/user/youtube/details';
        jQuery.ajax({
            url: ajax_url,
            data: formData,
            method: 'post',
            ...
            success: function(result) {  
                ...
                $('#addYoutubeBtn').prop("disabled", false);
                // console.log(result.status);
                if (result.status == 'success') {                    
                    $('.youtube_success_msg').html('Youtube video added successfully!');
                    location.reload();
                }
                if (result.status == 'validation_error') {
                    $.each(result.msg, function(key, val) {
                        if (result.msg.media_type) {
                            $('.youtube_video_error').text(result.msg.media_type);
                        }
                        if (result.msg.youtube_media_url) {
                            $('.youtube_url_error').text(result.msg.youtube_media_url);
                        }
                    });
                }
                if (result.status == 'error') {                                           
                    $('.youtube_url_error').text(result.msg);                       
                }
            }
        });
