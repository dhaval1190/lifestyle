    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">          
         @foreach($profile_Reviews as $profile_Review)
            <div class="row">
                <div class="col-8">
                    <form method="POST" action="{{ route('admin.page.reviews.update',$profile_Review->id) }}" name="review_form" id="review_form">
                        @csrf
                        @method('PUT')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('admin.page.reviews.destroy',$profile_Review->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#review_form').on('submit', function(e) {
                ...
                var url = "{{route('admin.page.reviews.update',$profile_Review->id)}}";                   
