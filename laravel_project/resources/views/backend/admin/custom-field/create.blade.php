...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-8 col-md-9">
            <h1 class="h3 mb-2 text-gray-800 font-sm-20">{{ __('backend.custom-field.add-custom-field') }}</h1>
            <p class="mb-4 font-sm-14">{{ __('backend.custom-field.add-custom-field-desc') }}</p>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-md-10 col-lg-6">
                    <form method="POST" action="{{ route('admin.custom-fields.store') }}" class="">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary py-2 px-4 text-white btn-100-width-sm ">
