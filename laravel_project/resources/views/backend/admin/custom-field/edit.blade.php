...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-8 col-md-9">
            <h1 class="h3 mb-2 text-gray-800 font-sm-20">{{ __('backend.custom-field.edit-custom-field') }}</h1>
            <p class="mb-4 font-sm-14">{{ __('backend.custom-field.edit-custom-field-desc') }}</p>
        </div>
        <div class="col-4 col-md-4text-right">
