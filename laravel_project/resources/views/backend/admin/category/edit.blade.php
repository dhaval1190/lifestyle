...
@section('content')
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{ route('admin.categories.update', ['category' => $category]) }}" class="">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row border-left-primary mb-4">
                            <div class="col-12">
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-check">
                                            <input {{ (old('category_thumbnail_type') ? old('category_thumbnail_type') : $category->category_thumbnail_type) == \App\Category::CATEGORY_THUMBNAIL_TYPE_IMAGE ? 'checked' : '' }} class="form-check-input" type="radio" name="category_thumbnail_type" id="category_thumbnail_type_image" value="{{ \App\Category::CATEGORY_THUMBNAIL_TYPE_IMAGE }}" aria-describedby="category_thumbnail_type_image_HelpBlock">
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6">
                                                <img id="image_preview" src="{{ old('category_image') ? old('category_image') : (!empty($category->category_image) ? \Illuminate\Support\Facades\Storage::disk('public')->url('category/'. $category->category_image) : asset('backend/images/placeholder/full_item_feature_image.webp')) }}" class="img-responsive">
                                            </div>
                                        </div>
                                ...
                                <div class="form-row mb-3">
                                    <div class="col-12">
                                        ...
                                        <select class="custom-select @error('category_header_background_type') is-invalid @enderror" name="category_header_background_type">
                                            <option value="{{ \App\Category::CATEGORY_HEADER_BACKGROUND_TYPE_INHERITED }}" {{ (old('category_header_background_type') ? old('category_header_background_type') : $category->category_header_background_type) == \App\Category::CATEGORY_HEADER_BACKGROUND_TYPE_INHERITED ? 'selected' : '' }}>{{ __('category_image_option.form-header-background-inherited') }}</option>
                                            <option value="{{ \App\Category::CATEGORY_HEADER_BACKGROUND_TYPE_COLOR }}" {{ (old('category_header_background_type') ? old('category_header_background_type') : $category->category_header_background_type) == \App\Category::CATEGORY_HEADER_BACKGROUND_TYPE_COLOR ? 'selected' : '' }}>{{ __('category_image_option.form-header-background-color') }}</option>
                                            <option value="{{ \App\Category::CATEGORY_HEADER_BACKGROUND_TYPE_IMAGE }}" {{ (old('category_header_background_type') ? old('category_header_background_type') : $category->category_header_background_type) == \App\Category::CATEGORY_HEADER_BACKGROUND_TYPE_IMAGE ? 'selected' : '' }}>{{ __('category_image_option.form-header-background-image') }}</option>
                                            <option value="{{ \App\Category::CATEGORY_HEADER_BACKGROUND_TYPE_VIDEO }}" {{ (old('category_header_background_type') ? old('category_header_background_type') : $category->category_header_background_type) == \App\Category::CATEGORY_HEADER_BACKGROUND_TYPE_VIDEO ? 'selected' : '' }}>{{ __('category_image_option.form-header-background-video') }}</option>
                                        </select>
                                        <small class="form-text text-muted">
