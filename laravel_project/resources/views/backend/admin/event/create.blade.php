                                                        ...
                                                        <div class="col-md-4 col-lg-8 col-xl-4">
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <input type="date" name="event_start_date"
                                                                    class="form_time"
                                                                    value="value="{{ old('event_start_date') }}"">
                                                            </div>
            ...
            <div class="content">
              ...
              <div class="form-group">
                ...
                <div class="input-group time" id="timepicker">
                  <input class="form-control" placeholder="HH:mm:ss"/><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-clock"></i></span></span>
                </div>
              </div>
            </div>
          </div>
