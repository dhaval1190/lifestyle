...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-12 col-md-12 col-lg-12 col-xl-6">
            <h1 class="h3 mb-2 text-gray-800 font-sm-20">{{ __('backend.term-of-service.term-of-service-page') }}</h1>
            <p class="mb-4 font-sm-14">{{ __('backend.term-of-service.term-of-service-page-desc') }}</p>
        </div>
    </div>
