...
@section('content')
    ...
    <div class="site-section">
        <div class="container">
            ...
            <!-- Start Filter -->
            <form method="GET" action="{{ route('page.state', ['state_slug' => $state->state_slug]) }}" id="filter_form">
                <div class="row pt-3 pb-3 ml-1 mr-1 mb-5 rounded border">
                    <div class="col-12">
                        ...
                        <div class="row form-group align-items-center">
                            ...
                            <div class="col-12 col-md-2 pl-0">
                                <select class="selectpicker form-control @error('filter_city') is-invalid @enderror" name="filter_city" id="filter_city" data-live-search="true">
                                    ...
                                    @foreach($filter_all_cities as $filter_all_cities_key => $city)
                        ...
                        <div class="row">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-outline-primary rounded" href="{{ route('page.state', ['state_slug' => $state->state_slug]) }}">
