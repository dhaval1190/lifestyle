...
<div class="swiper-slide">
    <div class="listing">
        <a href="{{ route('page.item', $item->item_slug) }}" class="img d-block listing_for_map_hover"
            ...
            <span class="text-white pl-1 pr-1 pt-1 pb-1 m-0 item-featured-label"
                style="float:left">{{ __('frontend.item.featured') }}</span>
        </a>
        <div class="lh-content">

            @foreach ($get_all_categories as $paid_item_categories_key => $category)
