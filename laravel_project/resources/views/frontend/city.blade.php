...
@section('content')
                ...
                <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-8 text-center">
                            <h1 style="color: {{ $site_innerpage_header_title_font_color }};">{{ $city->city_name }}, {{ $state->state_name }}</h1>
                            <p class="mb-0" style="color: {{ $site_innerpage_header_paragraph_font_color }};">{{ __('frontend.city.description') }}</p>
                        </div>
                    </div>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <!-- Start Filter -->
            <form method="GET" action="{{ route('page.city', ['state_slug' => $state->state_slug, 'city_slug' => $city->city_slug]) }}" id="filter_form">
                <div class="row pt-3 pb-3 ml-1 mr-1 mb-5 rounded border">
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-outline-primary rounded" href="{{ route('page.city', ['state_slug' => $state->state_slug, 'city_slug' => $city->city_slug]) }}">
