            ...
            <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                <div class="row justify-content-center mt-5">
                    <div class="col-md-8 text-center">
                        <h1 style="color: {{ $site_innerpage_header_title_font_color }};">{{ __('Youtube Videos') }}</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 plr-45">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="video">
                                        <div class='c-video__image-container vid-fit-user box-video-youtube' data-id="{{ $user_detail->id }}"
                                            id="#js-fitvideouser_{{ $user_detail->id }}" data-vid="box-video-youtube_{{ $user_detail->id }}">
                                            ...
                                            <div class="bt-play_user" id="bt-playuser_{{ $user_detail->id }}"></div>
                                            <iframe width="500" height="280" src="{{ $user_detail['youtube'] }}"
