...
@section('content')
    ...
    <div class="site-section">
        <div class="container">
            ...
            <!-- Start Filter -->
            <form method="GET" action="{{ route('page.user.categories', $user_detail['id']) }}" id="filter_form">
                        ...
                        <div class="row form-group align-items-center">
                            ...
                            <div class="col-12 col-md-2">
                                <select class="selectpicker form-control @error('filter_preferred_pronouns') is-invalid @enderror" name="filter_preferred_pronouns" id="filter_preferred_pronouns">
                                    <option value="0" {{ empty($filter_preferred_pronouns) ? 'selected' : '' }}>Any Gender</option>
