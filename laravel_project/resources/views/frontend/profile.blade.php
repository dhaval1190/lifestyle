                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('page.item.contact', ['item_slug' => $item->item_slug]) }}"
                                method="POST" name="contactFormModal" id="contactFormModal">
                                @csrf
                                ...
                                <div class="form-row mb-3">
                                    <div class="col-md-12">
                                        <label for="item_contact_email_note"
                                            class="text-black">{{ __('frontend.item.add-note') }}<span class="text-danger">*</span></label>
                                        <textarea class="form-control @error('item_contact_email_note') is-invalid @enderror" id="item_contact_email_note"
                                            rows="3" name="item_contact_email_note" {{ Auth::check() ? '' : 'disabled' }}>{{ old('item_contact_email_note') }}</textarea>
