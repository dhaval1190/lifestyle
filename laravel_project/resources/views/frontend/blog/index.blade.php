            ...
            <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-md-8 text-center">
                        <h1 style="color: {{ $site_innerpage_header_title_font_color }};">{{ __('frontend.blog.title') }}
                        </h1>
                        <p class="mb-0" style="color: {{ $site_innerpage_header_paragraph_font_color }};">
                            {{ __('frontend.blog.description') }}</p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-lg-8">
                                ...
                                <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
                                    ...
                                    <div class="h-entry shadow">
                                        @if (empty($post->featured_image))
                                            <div class="mb-3"
                                                style="min-height:300px;border-radius: 0.25rem;background-image:url({{ asset('frontend/images/placeholder/full_item_feature_image.webp') }});background-size:cover;background-repeat:no-repeat;background-position: center center;">
                                            </div>
                                        @else
                                            <div class="mb-3"
                                        ...
                                        <div class="blog_design_shadow">
                                            <h2 class="font-size-regular pt-0"><a
                                                    href="{{ route('page.blog.show', $post->slug) }}"
                    ...
                    @else
                        <div class="row">
                            <div class="col-md-12">
                                <p style="color:black;text-align:center;">{{ 'No Result Found!' }}</p>
                            </div>
                        </div>
                    @endif
