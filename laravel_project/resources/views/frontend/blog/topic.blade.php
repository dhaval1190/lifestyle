                ...
                <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-8 text-center">
                            <h1 style="color: {{ $site_innerpage_header_title_font_color }};">{{ trans_choice('frontend.blog.topic', 0) }}: {{ $topic->name }}</h1>
                            <p class="mb-0" style="color: {{ $site_innerpage_header_paragraph_font_color }};">{{ __('frontend.blog.topic-description', ['topic_name' => $topic->name]) }}</p>
                        </div>
                    </div>
