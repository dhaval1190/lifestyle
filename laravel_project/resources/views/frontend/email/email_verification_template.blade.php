        ...
        <div class="invoice-box">
                ...
                <tbody>
                    <tr>
                        <td
                            ...
                            <a href="{{ url('/email-verificaltion') }}/{{ $verify_token }}" style="color: #fff; text-decoration: none;">Verify Email Address</a>
                        </td>
                    </tr>
                </tbody>
            </table>
            <table>
                <tbody>
                    <tr>
                        <td>
                            <p style="padding: 10px 0px;">If you did not create an account, no further action is
                                required.</p>
                        </td>
                    </tr>
                </tbody>
            ...
            <table style="border-top: 1px solid #e8e5ef; padding: 20px 0px;">
                <tbody>
                    <tr>
                        <td>
                            <p style="padding: 20px 0px;">If you're having trouble clicking the "Verify Email Address"
                                button, copy and paste the URL below
                                into your web browser:
                                <span>
                                    <a href="{{ url('/email-verificaltion') }}/{{ $verify_token }}">{{ url('/email-verificaltion') }}/{{ $verify_token }}</a>
                                </span>
                            </p>
                        </td>
                    </tr>
            ...
            <tbody>
                <tr>
                    <td style="padding: 32px;">
                        <p style="text-align: center; color: #b0adc5; font-size: 12px; text-align: center">© {{ $year }} Coach
