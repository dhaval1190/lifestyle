                ...
                <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-10 text-center">
                            <h1 style="color: {{ $site_innerpage_header_title_font_color }};">{{ __('Email verification completed') }}</h1>
                        </div>
                    </div>
                ...
                <div class="col-md-7 mb-5">
                    ...
                    {{-- <form method="POST" action="" class="p-5 bg-white"> --}}
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <h5>Your email verification is completed</h5>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <a href="{{ route('login') }}">
                                    <button type="button" class="btn btn-primary py-2 px-4 text-white ml-5">{{ __('Go to Login') }}</button>
                                </a>
                            </div>
                        </div>
