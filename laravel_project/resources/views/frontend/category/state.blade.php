...
@section('content')
                ...
                <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-8 text-center">
                            ...
                            <p class="mb-0" style="color: {{ $site_innerpage_header_paragraph_font_color }};">{{ $state->state_name }}</p>
                        </div>
                    </div>
    ...
    <div class="site-section">
        <div class="container">
                        ...
                        @foreach( $children_categories as $key => $children_category )
                            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
                                ...
                                @elseif($children_category->category_thumbnail_type == \App\Category::CATEGORY_THUMBNAIL_TYPE_IMAGE)
                                    <a href="{{ route('page.category.state', ['category_slug' => $children_category->category_slug, 'state_slug' => $state->state_slug]) }}" class="popular-category h-100 image-category">
            ...
            <!-- Start Filter -->
            <form method="GET" action="{{ route('page.category.state', ['category_slug' => $category->category_slug, 'state_slug' => $state->state_slug]) }}" id="filter_form">
                <div class="row pt-3 pb-3 ml-1 mr-1 mb-5 rounded border">
                    <div class="col-12">
                        ...
                        <div class="row form-group align-items-center">
                            ...
                            <div class="col-12 col-md-2">
                                <select class="selectpicker form-control @error('filter_preferred_pronouns') is-invalid @enderror" name="filter_preferred_pronouns" id="filter_preferred_pronouns">
                                    <option value="0" {{ empty($filter_preferred_pronouns) ? 'selected' : '' }}>All Gender</option>
                            ...
                            <div class="col-12 col-md-2 pl-0">
                                <select class="selectpicker form-control @error('filter_city') is-invalid @enderror" name="filter_city" id="filter_city" data-live-search="true">
                                    ...
                                    @foreach($filter_all_cities as $all_cities_key => $city)
                        ...
                        <div class="row">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-outline-primary rounded" href="{{ route('page.category.state', ['category_slug' => $category->category_slug, 'state_slug' => $state->state_slug]) }}">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12 text-left border-primary">
                            <h2 class="font-weight-light text-primary">{{ __('frontend.category.state.sub-title-1', ['category_name' => $category->category_name, 'state_name' =>  $state->state_name]) }}</h2>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-7 text-left border-primary">
                    <h2 class="font-weight-light text-primary">{{ __('frontend.category.state.sub-title-2', ['category_name' => $category->category_name, 'state_name' => $state->state_name]) }}</h2>
                </div>
            </div>
            <div class="row mt-5">
