...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/custom_style.css?').rand() }}" />
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-Q9XK711017"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-Q9XK711017');
    </script>
