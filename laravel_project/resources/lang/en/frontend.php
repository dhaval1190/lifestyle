...
return array (
  ...
  array (
    ...
    'send-email-contact-note' => 'Note:-',
    'send-email-subject' => ':name shared a business coach with you',
    'send-email-subject-profile' => ':name shared a profile with you',
    'send-email-contact-subject' => 'Contact mail from :name',
    'send-email-article-title' => 'Article:- :article_name',
    'send-email-from-name' => 'Name:- :name',
    'send-email-from-email' => 'Email:- :email',
